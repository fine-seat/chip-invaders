...
class AlienTester:
    ...
    def __init__(self, dut):
        ...
        self.movement = dut.movement
        
        self.basic_alien = []
        
        _hex_path = Path(__file__).resolve().parent.parent / "src" / "rtl" / "basic_alien.hex"
...
async def test_reset(dut):
    ...
    assert have == tester.basic_alien[hpos][vpos], f"test_reset (x): Expected {tester.basic_alien[hpos][vpos]}, got {have}"
...
def test_alien_runner():
    ...
    import shutil
    shutil.copy(proj_path / "src" / "rtl" / "basic_alien.hex", hex_dir / "basic_alien.hex")
